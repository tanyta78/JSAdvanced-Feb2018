...
let rgbToHexColor = require("../index").rgbToHexColor;

describe("rgbToHexColor(red,green,blue) - returns hexadecimal string for rgb color", function () {
    describe('Normal typical cases - valid input', function () {
    ...
    describe('Special cases - invalid input', function () {
        ...
        it("should return undefined for ('5', [3], {a:4})", function () {
            expect(rgbToHexColor('5', [3], {a:4})).to.be.undefined;
        });
